        ...
        <div className="glass-card p-8 sm:p-10 relative" data-testid="auth-card">
          ...
          <div className="mt-6 inline-flex p-1 rounded-full bg-white/80 border border-line shadow-soft">
            <button
              ...
              style={tab === "login" ? { background: "linear-gradient(135deg, #6B8E7F, #D9B89C)" } : {}}
            >
              Login
            </button>
            <button
              ...
              style={tab === "signup" ? { background: "linear-gradient(135deg, #6B8E7F, #D9B89C)" } : {}}
            >
              Sign up
            </button>
          </div>
          ...
          <div className="flex items-center gap-3 my-5">
            ...
            <span className="text-[10px] uppercase tracking-[0.2em] text-muted font-semibold">or</span>
            <div className="flex-1 h-px bg-line" />
          </div>
          ...
          <button
            ...
            className="w-full h-12 rounded-full bg-white border border-line text-ink font-semibold flex items-center justify-center gap-3 hover:border-sage/40 hover:shadow-soft transition-all"
          >
